        ...
        <div className="flex flex-grow mt-10  flex-wrap md:pl-20 text-left">
          <div className="w-1/2 px-4">
            ...
            <nav className="list-none mb-10  flex flex-col gap-3   cursor-pointer footerLinks   text-lg font-normal">
              ...
              <a href="/speaker" className="hover:text-gray-500 ">
                Speakers
              </a>
            ...
            <nav className="list-none mb-10 footerLinks">
              <li className="mb-5">
                <div className="text-white">
                  Dr B R Ambedkar National Institute of Technology Jalandhar G.T
                  Road, Amritsar Bypass, Jalandhar, Punjab, India-144008
                </div>
              </li>
              <li className="mb-5 text-white">Telephone : +919888604632</li>
              <li>
                <a
                  href="mailto:wrec@nitj.ac.in"
      ...
      <div className="copyright_div border-t mt-6">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-2 justify-center sm:justify-start cursor-pointer">
            ...
            <a
              className="ml-3 text-gray-500"
              href="https://www.linkedin.com/school/dr-b-r-ambedkar-national-institute-of-technology-jalandhar-official/?originalSubdomain=in"
              target="_blank"
            >
              <img
