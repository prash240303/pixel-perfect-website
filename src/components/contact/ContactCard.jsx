...
function ContactCard({ item , lastCard}) {
    ...
    return (
        ...
        <div className={`flex w-full flex-col md:flex-row gap-6 ${lastCard ? '' : 'border-b border-black'}`}>            <div className=' w-full flex flex-col gap-6'>
            ...
            <div className='flex flex-col  item-center mb-6  gap-6'>
                <div className='img-cont'>
                    ...
                    <svg width="80" height="101" className='cutout' viewBox="0 0 81 101" fill="none" xmlns="http://www.w3.org/2000/svg">
