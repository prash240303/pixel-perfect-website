...
function Navbar() {
  return (
    <div class="w-full flex items-center justify-center border-b px-6 pb-3 border-black">
            <div class="flex w-full py-3 flex-col md:flex-row items-center border-x border-black  justify-center">
              <div class="md:ml-auto md:mr-auto flex flex-wrap items-center  pt-3 font-bold text-lg uppercase text-[#7E7E7E] cursor-pointer justify-center navbarLinks">
