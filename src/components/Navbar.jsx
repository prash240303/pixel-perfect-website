...
function Navbaar() {
  ...
  return (
    <>
      <Navbar className="sticky top-0 z-10 h-max max-w-full rounded-none border-b-black py-2 px-4 lg:px-6 lg:py-4">
        <div className="flex items-center justify-end md:border-x md:border-black text-black">
