...
function ContactUs() {
  ...
  return (
    <main className="view-container flex flex-col my-6 px-6 w-full  ">
      <div className='flex flex-col md:flex-row px-6 items-start justify-between w-full gap-6  border border-x-black  border-y-0'>
        ...
        <div className='flex   flex-col w-full items-start  py-6 border-t border-black gap-6 '>
          ...
          <div className='flex flex-col md:flex-row w-full gap-6' >
            ...
            <div className='flex flex-col text-2xl gap-3'>
              ...
              <a href="">
                <div className='mt-6 flex items-center justify-center  py-6 text-2xl font-bold bg-[#141414] hover:bg-zinc-800 text-white rounded-full uppercase'><a href="https://maps.google.com/maps/dir//Dr+B+R+Ambedkar+National+Institute+of+Technology+Jalandhar+Grand+Trunk+Road+Barnala+-+Amritsar+Bypass+Rd+Jalandhar,+Punjab+144011/@31.3958746,75.5358439,16z/data=!4m5!4m4!1m0!1m2!1m1!1s0x391a51d30c180edf:0x5b7633718d17ef33">Veiw on Maps</a></div>
              </a>
            </div>
          </div>
        </div>
